      ...
      <div className="w-full max-w-sm">
        ...
        <div className="flex items-center gap-3 mb-8 justify-center">
          ...
          <div>
            ...
            <p className="text-xs text-[#9BAABF] uppercase tracking-widest">Student Portal</p>
          </div>
        </div>

        <div className="bg-white rounded-2xl border border-[#DEE5F0] shadow-sm p-7">
          <h1 className="text-xl font-bold text-[#0D1B2E] mb-1">Welcome back</h1>
          <p className="text-sm text-[#5A6A82] mb-6">Sign in to your account</p>
